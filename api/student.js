...
router.post('/api/v1/students/add', function(req, res, next) {
  ...
  connection.query("INSERT INTO student SET ?", student, function(error, results, fields) {
    ...
    res.status(200).json({message: 'Successfully added a new student.'});z
  });
});

// API PUT edit student
router.put('/api/v1/students/:id/edit', function(req, res, next) {
...
router.put('/api/v1/students/:student_id/classes/:class_id/move', function(req, res, next) {
...
router.delete('/api/v1/students/:id/delete', function(req, res, next) {
  var student_id = req.params.id;
